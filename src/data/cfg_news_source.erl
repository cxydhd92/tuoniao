...
get(20030) ->
	#cfg_news_source{
		...
		sub_class = 1,
		name = <<"公众号.果壳"/utf8>>,
		summry = <<"科学和技术，是我们和这个世界对话所用的语言"/utf8>>,
		url = <<"https://www.waijiedanao.com/api/posts?profile=5d9c34c2a9a67271c371fdd7&page=1&limit=20"/utf8>>,
		type = 1,
		is_top = 0,
		link_pre = <<""/utf8>>,
		data = <<"data"/utf8>>,
...
get(20031) ->
	#cfg_news_source{
		...
		sub_class = 1,
		name = <<"公众号.差评"/utf8>>,
		summry = <<"Debug The World"/utf8>>,
		url = <<"https://www.waijiedanao.com/api/posts?profile=5d43ce40dacabc812aedbdd0&page=1&limit=20"/utf8>>,
		type = 1,
		is_top = 0,
		link_pre = <<""/utf8>>,
		data = <<"data"/utf8>>,
